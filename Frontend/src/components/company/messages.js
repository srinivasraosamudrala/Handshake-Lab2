...
class Messages extends Component {
    ...
    fetchmessages = () => {
        ...
        let data = localStorage.getItem('companyId');
        this.setState({ messagetext: "" })

        this.props.getMessages(data)

        // axios.defaults.headers.common['authorization'] = localStorage.getItem('token');
        // axios.get(environment.baseUrl+'/message/fetchmessages/' + localStorage.getItem('companyId'))
        //     .then((response) => {
        //         console.log(response.data)
                        ...
                        <div>
                            ...
                            <div style={{ height: '310px', paddingTop: '10px', overflow: 'auto', position: 'relative', top: '10px' }}>
                                ...
                                {convodetailed.messages.map((data, index) => {
                                    if (data.fromId === this.state.companyId) {
                                        return (
